	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homered" href="viewemp.php">Afficher les employés</a></li>
				<li><a class="homeblack" href="elogin.html">Déconnexion</a></li>
			</ul>
		</nav>
	</header>
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Mettre à jour les informations de l'employé</h2>
                    <form id = "registration" action="edit.php" method="POST">
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name="update">Soumettre</button>
                        </div>
